...
--
-- In production these are generated by tieto-generator (AI) from the Repository interface Javadoc
-- + the schema, then reviewed and committed. Here they are hand-written to keep the example
-- self-contained (docker compose loads this file at init). Either way, the acceptance gate is the
-- Repository tests in src/test — see OrderServiceIntegrationTest.
